...
//            actionImageView.setRichEditorAction(mRichEditorAction);
            ...
            actionImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ActionType type = (ActionType) v.getTag();
                    mRichEditorAction.execCommand(type);
...
//                .commit();
    ...
    private void initView() {
        ...
        RichEditorCallback mRichEditorCallback = new MRichEditorCallback();
    ...
    public void onKeyboardHeightChanged(int height, int orientation) {
        ...
        Log.i("KeyboardHeight = ", "height = " + height);
...
//        private RichEditorAction mRichEditorAction;
//
//        MOnActionPerformListener(RichEditorAction mRichEditorAction) {
